...
class DsEventTime extends DSource_Model {
	...
	public function __construct($timeId="",$eventId="",$startDate="",$endDate="",$startTime="",$endTime="") 
	{
    	...
    	$this->pk_names=[ 'timeId' ];
    	$this->fk_names=[ 'eventId'=>'eventId' ];
	}
