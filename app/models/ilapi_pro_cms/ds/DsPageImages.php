...
class DsPageImages extends DSource_Model {
	...
	public function __construct($imageId="",$pageId="",$imageName="",$imageSize="") 
	{
    	...
    	$this->pk_names=[ 'imageId' ];
    	$this->fk_names=[ 'pageId'=>'pageId' ];
	}
