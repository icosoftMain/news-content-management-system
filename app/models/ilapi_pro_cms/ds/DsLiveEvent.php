...
class DsLiveEvent extends DSource_Model {

	protected $liveEventId;

	protected $timeId;

	protected $speakerId;

	public function __construct($liveEventId="",$timeId="",$speakerId="") 
	{
    	...
    	$this->pk_names=[ 'liveEventId' ];
    	$this->fk_names=[ 'timeId'=>'timeId','speakerId'=>'speakerId' ];
	}
