...
class DsSpeakers extends DSource_Model {
	...
	public function __construct($speakerId="",$title="",$firstName="",$lastName="",$email="",$phoneNumber="",$imageName="",$about="",$_status="",$dateRegistered="") 
	{
