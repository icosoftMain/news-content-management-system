...
class DsPage extends DSource_Model {
	...
	public function __construct($sn="",$pageId="",$title="",$content="",$pageType="",$published="",$dateAdded="",$lastVisited="",$createdBy="",$source="",$pageViews="") 
	{
